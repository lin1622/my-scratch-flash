...
//        projectUrl = app.server.getProjectUrl();
    ...
    private function loadProjectFromURL(param1:String, param2:*):void{
        ...
        sb2Loader.addEventListener(Event.COMPLETE,handleComplete);
        sb2Loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR,handleError);
        sb2Loader.addEventListener(IOErrorEvent.IO_ERROR,handleError);
        try{
            sb2Loader.load(request);
            return;
        }catch(e:*){
            logException(e);
            return;
